...
import 'package:sales/screens/proveedor/list.dart';
import 'package:sales/screens/venta/list.dart';
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(
                  builder: (context) => const ProveedorListScreen(),
                ));
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(
                  builder: (context) => const VentaListScreen(),
                ));
              },
            ),
          ],
